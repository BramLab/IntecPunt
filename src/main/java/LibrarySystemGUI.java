...
public class LibrarySystemGUI extends JFrame {
    ...
    public LibrarySystemGUI() {
        ...
        memberService.addMember(new Member("Bram", 64, "bram.labarque@gmail.com", "1234"));
        memberService.addMember(new Member("Lucie",22,"lucie.monarchie@gmail.com","2468"));
        memberService.addMember(new Member("Lola",18,"lola.cawlo@gmail.com","4689"));
        memberService.addMember(new Member("Charlie",45,"charlie.chapline@gmail.com","7649"));
    ...
    private JPanel createMembersPanel() {
        ...
        addButton.addActionListener(e -> {
            ...
            if (name != null && !name.isEmpty()) {
                memberService.addMember(new Member(name, 0, name + "@mail.com", "pass"));
                refreshMembers();
            }
        });
